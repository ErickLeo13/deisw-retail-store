 ...
 *
 * @param amount    the monetary amount, it must not be null and must be greater than
 *                  or equal to zero
...
public record Money(BigDecimal amount, Currency currency) {
  ...
  /**
   * Constructs a Money object with a zero amount in USD.
   */
  public Money() {
   ...
   *
   * @param amount    the monetary amount, it must not be null and must be greater than
   *                  or equal to zero, with decimal digits according to the currency
   * @param currency  the currency, it must not be null
   * @throws IllegalArgumentException if the amount is null
   *      or less than zero, or if the currency is null
   *
   */
  public Money {
    ...
    if (amount.scale() > currency.getDefaultFractionDigits()) {
      throw new IllegalArgumentException("Amount scale must be less than or "
          + "equal to the currency fraction digits");
    }
  }
